...
unlocked to sign the WOLF-Qt.app bundle.
...
allowing somebody to distribute a WOLF-Qt.app or wolf-qt-setup.exe with a valid
...
that the wolf-qt.exe file inside the installer had not been tampered with.
