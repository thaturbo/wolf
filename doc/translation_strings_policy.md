...
This document provides guidelines for internationalization of the WOLF Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `wolf_en.ts` remains unchanged.
