...
This mechanism has been integrated into Bitcore-Node-WOLF which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/wolfcrypto/insight-api-wolf#web-socket-api](https://github.com/wolfcrypto/insight-api-wolf#web-socket-api)
* API: [https://github.com/wolfcrypto/insight-api-wolf#instantsend-transactions](https://github.com/wolfcrypto/insight-api-wolf#instantsend-transactions)
...
By default, the WOLF Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the WOLF Core daemon:
