...
#include "config/wolf-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatWOLFURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + WOLFUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatWOLFURI(info));
}
