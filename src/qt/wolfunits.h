...
#ifndef WOLF_QT_WOLFUNITS_H
#define WOLF_QT_WOLFUNITS_H
...
/** WOLF unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class WOLFUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit WOLFUnits(QObject *parent);

    /** WOLF units.
      @note Source: https://en.wolf.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        WOLF,
...
typedef WOLFUnits::Unit WOLFUnit;

#endif // WOLF_QT_WOLFUNITS_H
