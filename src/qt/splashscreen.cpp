    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightTextWOLF   = QChar(0xA9)+QString(" 2017-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("A wolfpack production"));
    ...
    pixPaint.drawText(paddingLeft,paddingTop+titleCopyrightVSpace,copyrightTextWOLF);
