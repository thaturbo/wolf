    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("WOLF-light"), QVariant("light"));
    ui->theme->addItem(QString("WOLF-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("WOLF-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("WOLF-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("WOLF-traditional"), QVariant("trad"));
    ...
    ui->unit->setModel(new WOLFUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->wolfAtStartup, OptionsModel::StartAtStartup);
