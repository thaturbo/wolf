...
public:
    TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(WOLFUnits::WOLF),
                      ...
                      const QModelIndex &index ) const
    {
        ...
        painter->setPen(foreground);
        QString amountText = WOLFUnits::floorWithUnit(unit, amount, true, WOLFUnits::separatorAlways);
        if(!confirmed)
        {
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& anonymizedBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(WOLFUnits::floorHtmlWithUnit(nDisplayUnit, balance, false, WOLFUnits::separatorAlways));
    ui->labelUnconfirmed->setText(WOLFUnits::floorHtmlWithUnit(nDisplayUnit, unconfirmedBalance, false, WOLFUnits::separatorAlways));
    ui->labelImmature->setText(WOLFUnits::floorHtmlWithUnit(nDisplayUnit, immatureBalance, false, WOLFUnits::separatorAlways));
    ui->labelAnonymized->setText(WOLFUnits::floorHtmlWithUnit(nDisplayUnit, anonymizedBalance, false, WOLFUnits::separatorAlways));
    ui->labelTotal->setText(WOLFUnits::floorHtmlWithUnit(nDisplayUnit, balance + unconfirmedBalance + immatureBalance, false, WOLFUnits::separatorAlways));
    ui->labelWatchAvailable->setText(WOLFUnits::floorHtmlWithUnit(nDisplayUnit, watchOnlyBalance, false, WOLFUnits::separatorAlways));
    ui->labelWatchPending->setText(WOLFUnits::floorHtmlWithUnit(nDisplayUnit, watchUnconfBalance, false, WOLFUnits::separatorAlways));
    ui->labelWatchImmature->setText(WOLFUnits::floorHtmlWithUnit(nDisplayUnit, watchImmatureBalance, false, WOLFUnits::separatorAlways));
    ui->labelWatchTotal->setText(WOLFUnits::floorHtmlWithUnit(nDisplayUnit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, WOLFUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    {
        // update the display unit, to not use the default ("WOLF")
        updateDisplayUnit();
...
void OverviewPage::updatePrivateSendProgress()
{
    ...
    QString strPrivateSendAmount = WOLFUnits::formatHtmlWithUnit(nDisplayUnit, privateSendClient.nPrivateSendAmount * COIN, false, WOLFUnits::separatorAlways);
    ...
    if(currentBalance == 0)
    {
        ...
        strPrivateSendAmount = strPrivateSendAmount.remove(strPrivateSendAmount.indexOf("."), WOLFUnits::decimals(nDisplayUnit) + 1);
    ...
    if(nMaxToAnonymize >= privateSendClient.nPrivateSendAmount * COIN) {
        ...
        QString strMaxToAnonymize = WOLFUnits::formatHtmlWithUnit(nDisplayUnit, nMaxToAnonymize, false, WOLFUnits::separatorAlways);
        ui->labelAmountRounds->setToolTip(tr("Not enough compatible inputs to anonymize <span style='color:red;'>%1</span>,<br>"
                                             "will anonymize <span style='color:red;'>%2</span> instead")
                                          .arg(strPrivateSendAmount)
                                          .arg(strMaxToAnonymize));
        strMaxToAnonymize = strMaxToAnonymize.remove(strMaxToAnonymize.indexOf("."), WOLFUnits::decimals(nDisplayUnit) + 1);
        strAmountAndRounds = "<span style='color:red;'>" +
                QString(WOLFUnits::factor(nDisplayUnit) == 1 ? "" : "~") + strMaxToAnonymize +
...
void OverviewPage::togglePrivateSend(){
    ...
    if(!privateSendClient.fEnablePrivateSend){
        ...
        if(currentBalance < nMinAmount){
            QString strMinAmount(WOLFUnits::formatWithUnit(nDisplayUnit, nMinAmount));
            QMessageBox::warning(this, tr("PrivateSend"),
