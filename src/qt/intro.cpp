...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR) || dataDirDefaultCurrent != dataDirDefaultSettings)
    {
        ...
        intro.setWindowIcon(QIcon(":icons/wolf"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("WOLF Core"),
     ...
     * override -datadir in the wolf.conf file in the default data directory
     * (to be consistent with wolfd behavior)
     */
