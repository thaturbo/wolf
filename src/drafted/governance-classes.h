 ...
 *
 *   // network
 *   CWOLFNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.wolf.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CWOLFNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: WOLFNetwork
// //   -- signature requirements : Key1(User)
// class CWOLFNetworkVariable : public CGovernanceObject
// {
// private:
