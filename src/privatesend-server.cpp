...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all WOLF related functionality
...
/*
    ...
    allow endless transaction that would bloat WOLF and make it unusable. To
