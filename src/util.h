...
//#define ENABLE_WOLF_DEBUG
#ifdef ENABLE_WOLF_DEBUG
#define DBG( x ) x
#else
#define DBG( x ) 
#endif
...
extern const char * const WOLF_CONF_FILENAME;
extern const char * const WOLF_PID_FILENAME;
...
{
    std::string s = strprintf("wolf-%s", name);
