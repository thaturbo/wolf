...
#ifndef WOLF_TEST_SCRIPTNUM10_H
#define WOLF_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from WOLF Core 0.10.0, for cross-comparison.
 */
public:
