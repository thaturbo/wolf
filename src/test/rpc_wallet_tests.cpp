...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CWOLFAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CWOLFAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey(0, false);
        demoAddress = CWOLFAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CWOLFAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CWOLFAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CWOLFAddress(arr[0].get_str()).Get() == demoAddress.Get());
